...
export default function ContactPage() {
  return (
    <>
      ...
      <section className="pt-40 pb-36 md:pt-52 md:pb-56">
        <div className="container-wide">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 lg:gap-32">
            <div>
              ...
              <p className="text-lg mb-14" style={{ color: 'var(--color-text-muted)', lineHeight: '1.7' }}>
              ...
              <div className="p-8 rounded-xl" style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)' }}>
                <h3 className="text-sm font-semibold mb-5">What happens next?</h3>
            ...
            <div className="p-12 rounded-2xl" style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)' }}>
              <h2 className="text-xl font-bold mb-10" style={{ fontFamily: 'var(--font-display)' }}>Get Your Free Quote</h2>
              <ContactForm />
            </div>
          </div>
        </div>
