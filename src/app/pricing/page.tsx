  ...
  return (
    <>
        ...
        <div className="container-wide">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map(service => (
              <div key={service.slug} className="p-10 rounded-2xl flex flex-col" style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)' }}>
      ...
      <section className="py-36 md:py-56" style={{ background: 'var(--color-surface)' }}>
        <div className="container-default">
          <h2 className="text-2xl md:text-3xl font-bold mb-5 text-center" style={{ fontFamily: 'var(--font-display)' }}>Bangkok vs. Western Pricing</h2>
          <p className="text-base text-center mb-16 max-w-xl mx-auto" style={{ color: 'var(--color-text-muted)' }}>
      ...
      <section className="py-36 md:py-56">
        <div className="container-default">
          <h2 className="text-2xl md:text-3xl font-bold mb-20 text-center" style={{ fontFamily: 'var(--font-display)' }}>Every Project Includes</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={item} className="flex items-center gap-4 p-7 rounded-xl" style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)' }}>
