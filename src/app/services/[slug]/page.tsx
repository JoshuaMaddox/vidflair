  ...
  return (
    <>
      ...
      <section className="py-36 md:py-56" style={{ background: 'var(--color-surface)' }}>
        <div className="container-wide">
          <h2 className="text-2xl md:text-3xl font-bold mb-20" style={{ fontFamily: 'var(--font-display)' }}>What&apos;s Included</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {service.features.map(feature => (
              <div key={feature} className="flex items-start gap-4 p-7 rounded-xl" style={{ background: 'var(--color-surface-2)', border: '1px solid var(--color-border)' }}>
      ...
      <section className="py-36 md:py-56">
        <div className="container-default">
          <h2 className="text-2xl md:text-3xl font-bold mb-20 text-center" style={{ fontFamily: 'var(--font-display)' }}>Our Process</h2>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            {[
              ...
              <div key={item.step} className="text-center p-10 rounded-2xl" style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)' }}>
                <span className="text-3xl font-bold mb-5 block" style={{ fontFamily: 'var(--font-display)', color: 'var(--color-accent)' }}>{item.step}</span>
                <h3 className="text-base font-semibold mb-4" style={{ fontFamily: 'var(--font-display)' }}>{item.title}</h3>
      ...
      <section className="py-36 md:py-56">
        <div className="container-wide">
          <h2 className="text-2xl md:text-3xl font-bold mb-20" style={{ fontFamily: 'var(--font-display)' }}>Other Services</h2>
