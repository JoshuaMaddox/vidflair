    ...
    <>
      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-24">
        <div className="container-default">
          ...
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-8" style={{ fontFamily: 'var(--font-display)', lineHeight: '1.05' }}>
              Professional Video Production,{' '}
              <span className="text-gradient">Built for International Brands</span>
            </h1>
            <p className="text-lg md:text-xl mb-6" style={{ color: 'var(--color-text-muted)', lineHeight: '1.7' }}>
      ...
      <section className="py-16 md:py-24" style={{ background: 'var(--color-surface)' }}>
        <div className="container-wide">
          <h2 className="text-2xl md:text-3xl font-bold mb-12 text-center" style={{ fontFamily: 'var(--font-display)' }}>What We Stand For</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.title} className="p-8 rounded-2xl" style={{ background: 'var(--color-surface-2)', border: '1px solid var(--color-border)' }}>
                <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-5" style={{ background: 'var(--color-accent-muted)', color: 'var(--color-accent)' }}>
                  {item.icon}
                </div>
        ...
        <div className="container-wide">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={stat.label} className="text-center p-6 rounded-2xl" style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)' }}>
                <div className="text-3xl md:text-4xl font-bold mb-2" style={{ fontFamily: 'var(--font-display)', color: 'var(--color-accent)' }}>{stat.value}</div>
      ...
      <section className="py-16 md:py-24" style={{ background: 'var(--color-surface)' }}>
        <div className="container-default">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-6" style={{ fontFamily: 'var(--font-display)' }}>The Bangkok Advantage</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-left">
              {[
                ...
                <div key={item.text} className="flex items-start gap-3 p-4 rounded-xl" style={{ background: 'var(--color-surface-2)', border: '1px solid var(--color-border)' }}>
