    ...
    <>
      ...
      <section className="py-28 md:py-40" style={{ background: 'var(--color-surface)' }}>
        <div className="container-wide">
          <h2 className="text-2xl md:text-3xl font-bold mb-16 text-center" style={{ fontFamily: 'var(--font-display)' }}>What We Stand For</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={item.title} className="p-10 rounded-2xl" style={{ background: 'var(--color-surface-2)', border: '1px solid var(--color-border)' }}>
                <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-6" style={{ background: 'var(--color-accent-muted)', color: 'var(--color-accent)' }}>
                  {item.icon}
                </div>
                <h3 className="text-lg font-semibold mb-4" style={{ fontFamily: 'var(--font-display)' }}>{item.title}</h3>
        ...
        <div className="container-wide">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={stat.label} className="text-center p-8 rounded-2xl" style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)' }}>
                <div className="text-3xl md:text-4xl font-bold mb-3" style={{ fontFamily: 'var(--font-display)', color: 'var(--color-accent)' }}>{stat.value}</div>
      ...
      <section className="py-28 md:py-40" style={{ background: 'var(--color-surface)' }}>
        <div className="container-default">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-8" style={{ fontFamily: 'var(--font-display)' }}>The Bangkok Advantage</h2>
            <p className="text-base mb-14" style={{ color: 'var(--color-text-muted)', lineHeight: '1.7' }}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-left">
              {[
                ...
                <div key={item.text} className="flex items-start gap-4 p-6 rounded-xl" style={{ background: 'var(--color-surface-2)', border: '1px solid var(--color-border)' }}>
